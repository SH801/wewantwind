"""
Django settings for wewantwind project.
...
SECRET_KEY = 'p^3%avdok@#sisaz_25=^()41!iph-2g%w@n4_1-5_j^5uql!k'
...
WSGI_APPLICATION = 'wewantwind.wsgi.application'
